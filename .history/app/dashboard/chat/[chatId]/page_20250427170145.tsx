// import { ReactElement } from 'react'; // Remove this unused import
...
// @ts-expect-error // Next.js generated types expect params: Promise<any> here, which seems incorrect.
export default async function ChatPage({
  ...
  try {
    // const { params } = props; // This line should already be removed or commented out
